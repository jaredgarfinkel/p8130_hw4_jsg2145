...
power of the slope. There is an `r exp(5.5+.2256)` increase in cost associated with each emergency visit.

So, for a third visit, there would be an expected increase in cost of 3 * `r exp(5.5+.2256)` = `r 3*exp(5.5+.2256)`
